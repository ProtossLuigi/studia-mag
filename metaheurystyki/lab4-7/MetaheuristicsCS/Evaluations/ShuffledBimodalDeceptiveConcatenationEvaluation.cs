...
{
    class ShuffledBimodalDeceptiveConcatenationEvaluation : CBinaryBimodalDeceptiveConcatenationEvaluation
    {
        private List<int> permutation;

        public ShuffledBimodalDeceptiveConcatenationEvaluation(int iBlockSize, int iNumberOfBlocks, int? seed = null)
